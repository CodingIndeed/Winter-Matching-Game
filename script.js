...
function onCardFlipped(newlyFlippedCard) {
  // Step 1: Add one to the flip counter UI.
	...
	incrementCounter("flip", parentElement);
...
let time = document.getElementById("time-count");
let seconds = 120;
...
// End of the game function to show the end of the game banner.
function endofGame() {
	let endBanner = document.createElement("div");
	let gameContainer = document.getElementById("game-container");
	endBanner.innerHTML = `<span class="end-of-game-text"> GAME OVER </span> <button class="restart-button" onClick="restart()">Play Again!</button>`;
	endBanner.classList.add("end-of-game");
	gameContainer.appendChild(endBanner);
}
